# ✍️ EssayNest — AI Essay Scoring & Writing Analytics
...
**EssayNest** is an AI-assisted full-stack essay evaluation and writing analytics platform built using **Natural Language Processing (NLP)**, **Machine Learning**, **React**, and **FastAPI**.
...
EssayNest combines **TF-IDF features** with numerical linguistic and text features to predict an essay score using **Linear Regression**.
...
EssayNest provides insights into:
...
EssayNest uses a writing-focused interface designed like a **modern digital writing studio**.
